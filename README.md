...
* **Catalog Concentration & Return Exposure:** Just three SKUs (Gaming Monitor, Apple AirPods, and MacBook Air) consistently generated ~85% of annual revenue, creating substantial dependence on a narrow product set. Return exposure was similarly concentrated, with four core SKUs accounting for ~98% of refunded value (~$2.2M).
