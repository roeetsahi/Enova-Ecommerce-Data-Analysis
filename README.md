...
* **Catalog Concentration & Return Exposure:** Just three SKUs (Gaming Monitor, Apple AirPods, and MacBook Air) consistently generated ~85% of annual revenue, making revenue heavily dependent on a narrow product set. Separately, return-related financial exposure was concentrated in four core SKUs, which accounted for ~98% of total refunded value (~$2.2M).
